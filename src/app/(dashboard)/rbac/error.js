...
export default function RbacError({ error, reset }) {
  return (
    <main className="mx-auto max-w-6xl px-4 py-12 text-center">
      <div className="rounded-xl border border-red-100 bg-white px-6 py-8 shadow-sm">
        <h2 className="text-lg font-bold text-brand-dark">Lỗi tải phân quyền</h2>
        <p className="mt-2 text-sm text-gray-600">
          Không thể tải dữ liệu RBAC. Vui lòng thử lại.
        </p>
